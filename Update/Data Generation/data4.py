...
# Optimized synthetic data generator preserving original outputs and structure
# Key improvements: vectorized project parameter generation, batched random draws
# for timesheet entries per task, and avoiding expensive groupby lambdas.
